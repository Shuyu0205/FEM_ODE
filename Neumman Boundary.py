#This is a program for using finite elements method to solve 1D helmhotz equation with constan neumann bounadary!
from numpy import *
...
elements_solve=[3,5,100]#Maybe overfit?
            ...
            for e in Element:#Start the whole algorithm
                    ...
                    for i_int in gausspoint:
                        #Strat with setting everything needed.
                            ...
                            Neumann=5j #specify you right hand Nuemann boundary here
                            Modifier=Neumann/3
